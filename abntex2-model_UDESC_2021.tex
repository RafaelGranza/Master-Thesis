...
\preambulo{Dissertation submitted to the Graduate Program in Applied Computing of the Centro de Ciências Tecnológicas at the Universidade do Estado de Santa Catarina, as a partial requirement for obtaining the degree of Master in Applied Computing.}
...
\include{Textuais/Background}
\include{Textuais/Characterization}
\include{Textuais/Design}
\include{Textuais/Framework}
\include{Textuais/Fair}
