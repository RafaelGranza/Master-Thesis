...
\begin{figure}[!ht]
    ...
    \caption[Example of a possible flowchart for the Assigner.]{Example of a possible flowchart for the Assigner. The solvers shown here are explained at Section \ref{sec:implemented_solvers}.}
