...
class Solver:
    ...
    The solvers implemented in this framework are available at Appendices \ref{app:solver_ga}, \ref{app:solver_hungarian}, \ref{app:solver_binary_search} and \ref{app:solver_stable_marriage}.
